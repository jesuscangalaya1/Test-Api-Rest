package com.avatar.report.helper;
...
public class PdfExportHelper {
        ...
        for (Map<String, String> value : values) {
            for (String columna : colNames) {
                ...
                switch (columna) {
                    ...
                    case "NOMBRE" ->
                            cell.setWidth(UnitValue.createPercentValue(20)); // Ajusta el valor para el tamaño deseado
                    case "DESCRIPTION" ->
                            cell.setWidth(UnitValue.createPercentValue(30)); // Ajusta el valor para el tamaño deseado
                    case "PRECIO" -> cell.setWidth(UnitValue.createPercentValue(18));
                    case "STOCK" -> cell.setWidth(UnitValue.createPercentValue(13));
                }
                table.addCell(cell);
            }
        }
    ...
    private static Style createHeaderCellStyle() {
        return createCellStyle(new DeviceRgb(102, 102, 153));
    }

    private static Style createCellStyle() {
        return createCellStyle(ColorConstants.WHITE);
    }

    private static Style createCellStyle(Color backgroundColor) {
